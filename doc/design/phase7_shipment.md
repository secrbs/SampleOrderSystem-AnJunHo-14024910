...
| ID | 내용 | 예상 결과 |
|----|------|-----------|
| T6-01 | CONFIRMED 주문 출고 실행 | 상태 RELEASE로 전환 |
| T6-02 | CONFIRMED 아닌 주문 출고 시도 | 오류, 상태 변경 없음 |
| T6-03 | CONFIRMED 주문 없을 때 | "출고 가능한 주문 없음" 출력 |
| T6-04 | 출고 후 RELEASE 상태 확인 | RELEASE 상태로 조회됨 |
