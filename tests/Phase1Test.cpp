...
protected:
    ...
    const std::string samplePath = "test_samples.json";
    const std::string orderPath  = "test_orders.json";
    const std::string queuePath  = "test_queue.json";
};
...
TEST_F(Phase1Test, T1_05_SystemStatusWithData) {
    ...
    writeJson(orderPath, R"([
        {"orderId":"ORD-001","sampleId":"S-001","customerName":"고객A","quantity":10,"status":"RESERVED","createdAt":"","updatedAt":""},
        {"orderId":"ORD-002","sampleId":"S-002","customerName":"고객B","quantity":20,"status":"CONFIRMED","createdAt":"","updatedAt":""}
    ])");
    writeJson(queuePath, R"([
        {"orderId":"ORD-003","sampleId":"S-001","shortage":50,"actualProduction":61,"totalTime":30.5,"enqueuedAt":""}
    ])");
